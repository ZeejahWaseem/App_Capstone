...
![alt text](Images/ConfusionMatrix_DecisionTree.PNG)
...
![alt text](Images/ConfusionMatrix_RandomForest.PNG)
...
![alt text](Images/ConfusionMatrix_XGBoost.PNG)
...
![alt text](Images/MostImpFeature.PNG)
...
![alt text](Images/LoansApproved_Property.PNG)
...
![alt text](Images/LoansApproved_LoanAmount.PNG)
